  ...
  return (
    <div className="animate-scene-camera mt-14 relative mx-auto max-w-5xl">
      ...
      >
        ...
        {/* LAYER 2: SVG Glowing Data Conduits / Optical Fiber Pathways */}
        <svg
          className="pointer-events-none absolute inset-0 -z-10 h-full w-full overflow-visible hidden sm:block"
          viewBox="0 0 1000 600"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          <defs>
            <linearGradient id="conduitGrad1" x1="100%" y1="0%" x2="50%" y2="50%">
              <stop offset="0%" stopColor="#10b981" stopOpacity="0.8" />
              <stop offset="100%" stopColor="#6366f1" stopOpacity="0.2" />
            </linearGradient>
            <linearGradient id="conduitGrad2" x1="0%" y1="100%" x2="50%" y2="50%">
              <stop offset="0%" stopColor="#6366f1" stopOpacity="0.8" />
              <stop offset="100%" stopColor="#06b6d4" stopOpacity="0.2" />
            </linearGradient>
          </defs>

          {/* Top-Right Conduit Line */}
          <path
            d="M 920 20 Q 800 40 700 90"
            stroke="url(#conduitGrad1)"
            strokeWidth="1.5"
            className="animate-conduit-flow animate-laser-glow"
          />

          {/* Bottom-Left Conduit Line */}
          <path
            d="M 80 540 Q 200 500 300 460"
        ...
        {/* LAYER 3: Connected Holographic Satellite Modules */}
        ...
        {/* LAYER 4: Main Living Chassis Object */}
