        ...
        <div className="p-3 space-y-4">
          ...
          <div className="flex items-center justify-between md:hidden pb-2 border-b border-sidebar-border">
            ...
            <button
              ...
              className="rounded-lg p-1.5 text-muted-foreground hover:bg-sidebar-accent cursor-pointer"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
          ...
          <div className="space-y-0.5">
            ...
            <div>
              <button
                ...
                title={isCollapsed ? "Postgres database" : undefined}
                className={cn(
              ...
              >
                <div className="flex items-center gap-3 truncate">
                  ...
                  {!isCollapsed && <span className="truncate">Postgres database</span>}
                </div>
                {!isCollapsed && (
                  postgresExpanded ? (
