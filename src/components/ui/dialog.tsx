...
export function DialogContent({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      <div
        className={cn(
          "relative z-50 w-full rounded-xl border bg-card p-6 shadow-2xl transition-all animate-in zoom-in-95 duration-200 text-card-foreground my-8 max-h-[90vh] overflow-y-auto",
          maxWidth,
          className
        )}
